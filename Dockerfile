...
# Execute unit tests
RUN dotnet test ./Tests/SouthGloucestershireBinCollection.Tests.UnitTests/SouthGloucestershireBinCollection.Tests.UnitTests.csproj /p:CollectCoverage=true /p:CoverletOutput="../result/codecoverage/coverage.json"
...
RUN dotnet nuget push ./out/SouthGloucestershireBinCollection.$PACKAGE_VERSION.nupkg -s https://api.nuget.org/v3/index.json -k $NUGET_PACKAGE_API